...
import { useDestroyEstimateItem, useUpdateEstimateItem } from '@billing/estimate/hooks/mutations'
...
export const EstimateItemEdit = ({ item }: Props) => {
    const { id } = useParams()
                    ...
                    return (
                        <Form useForm={form} onSubmit={(data) => handleSubmit(data, handleClose)}>
                            ...
                            <div className="flex flex-col gap-2">
                                <Button isLoading={updateEstimateItem.isPending} type="submit">
                                    Sauvegarder
                                </Button>
