...
import { useCreateRecurringInvoiceItem } from '@billing/recurring-invoice/hooks/mutations'
...
export const ItemManager = () => {
    ...
    const { mutate, isPending } = useCreateRecurringInvoiceItem()
            ...
            },
            {
                onSuccess: () => {
                    queryClient.invalidateQueries({
                        queryKey: ['recurring-invoices', { id: Number(recurring_invoice_id) }]
                    })
